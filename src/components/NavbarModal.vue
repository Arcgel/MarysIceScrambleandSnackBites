<template>
  <nav class="NavbarModal">
    <div class="logo">
      ...
      <RouterLink :to="{ about }"><h2>Mary's Ice Screamble and SnackBites</h2></RouterLink>
    </div>
    <div class="actualnav">
      <ul>
...
.actualnav details[open] ul {
  display: block;
}

.actualnav details ul {
  display: none;
  position:fixed;
  list-style: none;
  margin: 0;
...
.actualnav details ul li a:hover {
